"""Train DMT for unconditional / conformer generation (NExT-Mol stage 2)."""
...
def main():
    ...
    setup_logging(level=args.log_level, log_file=args.log_file, run_name="train_dmt_uncond")
    log.info("Starting DMT unconditional training")
    ...
    train_cfg = NextMolTrainingConfig(use_llm=args.use_llm, delta_train_epochs=10)
    ...
    log.info("DMT unconditional training complete")
