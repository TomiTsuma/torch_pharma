...
from torch_pharma.utils.io import save_xyz_file
from torch_pharma.utils.visualize import visualize_mol_chain
...
def save_and_sample_conditionally(
    ...
    save_xyz_file(
        path=f"outputs/{experiment_name}/analysis/run{epoch}/",
        positions=x,
        one_hot=one_hot,
        charges=charges,
